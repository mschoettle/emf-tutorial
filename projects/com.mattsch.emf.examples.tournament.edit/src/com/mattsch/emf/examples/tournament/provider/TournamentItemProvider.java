...
/**
 * This is the item provider adapter for a {@link com.mattsch.emf.examples.tournament.Tournament} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TournamentItemProvider extends NamedElementItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(TournamentPackage.Literals.TOURNAMENT__GROUPS);
            childrenFeatures.add(TournamentPackage.Literals.TOURNAMENT__TEAMS);
            childrenFeatures.add(TournamentPackage.Literals.TOURNAMENT__MATCHES);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (TournamentPackage.Literals.TOURNAMENT__GROUPS,
                 TournamentFactory.eINSTANCE.createGroup()));

        newChildDescriptors.add
            (createChildParameter
                (TournamentPackage.Literals.TOURNAMENT__TEAMS,
                 TournamentFactory.eINSTANCE.createTeam()));

        newChildDescriptors.add
            (createChildParameter
                (TournamentPackage.Literals.TOURNAMENT__MATCHES,
                 TournamentFactory.eINSTANCE.createMatch()));
    }
